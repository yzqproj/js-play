...
export function post(url: string, form: any) {
...
export function get(url: string, form = {}, cache = false) {
  if (cache) {
...
function getFromServer(url: string, params: any) {
